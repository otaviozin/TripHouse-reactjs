...
function Home(){
    return(
        <div>
            <Navbar />
            <section className="container mt-5 px-4 px-lg-5" style={{height: 551}}>
                <div className="row align-items-center justify-content-center text-center h-75">
            ...
            <section id="about" className="bg-coral py-5 shadow">
                <div className="container text-center">
                    <h1>Trip House</h1>  
                    <p className="mx-5 my-3">Somos uma empresa locadora de pousadas e casas para você e sua família viajarem com o maior conforto possível. Queremos sempre o conforto de nossos hóspedes, então solicitamos uma revisão no local assim que outra pessoa termina sua temporada, garantindo a sua segurança e evitando dores de cabeça no meio da sua viagem.</p>
                    <p className="mx-5">Para que tenhamos controle das avaliações e dos locais, solicitamos o nome, endereço e CPF da pessoa que irá alugar. Assim evitamos que pessoas não reais façam o uso inapropriado ou avaliem de forma negativa algum imóvel.</p>
                    <a className="btn btn-coral" href="/rent">Veja nossos imóveis</a>
                </div>
            </section>

            <section id="contact" className="container px-5 pt-4 pb-5">
                <div className="row">
                    <h1 className="mb-5">Contatos</h1>
                            ...
                            <div className="card-body">
                                ...
                                <form>
                                    ...
                                    <div class="form-floating my-3">
                                        ...
                                        <label for="floatingTextarea2">Qual é a sua dúvida ou reclamação?</label>
                                    </div>
                    ...
                    <div className="col-md-6">
                        <div className="card shadow">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text my-3 fs-5"><i class="fas fa-phone me-2"></i>+55 11 9876-5432</p>
